...
如果您在使用 摆烂仙君 时遇到任何问题，请按照以下步骤报告：

1. **检查现有问题**：在提交新问题之前，请先检查 [Issues](https://github.com/摆烂仙君Devs/摆烂仙君/issues) 中是否已经存在类似的问题。
...
If you encounter any issues while using 摆烂仙君, please follow these steps to report them:
1. **Check Existing Issues**: Before submitting a new issue, please check if a similar issue already exists in the [Issues](https://github.com/摆烂仙君Devs/摆烂仙君/issues) section of the repository.
