...
from astrbot.core import 摆烂仙君Config, logger
...
class 摆烂仙君ConfigManager:
    """A class to manage the system configuration of 摆烂仙君, aka ACM"""

    def __init__(
        self,
        default_config: 摆烂仙君Config,
        ucr: UmopConfigRouter,
        sp: SharedPreferences,
    ) -> None:
        self.sp = sp
        self.ucr = ucr
        self.confs: dict[str, 摆烂仙君Config] = {}
        """uuid / "default" -> 摆烂仙君Config"""
    ...
    def _load_all_configs(self) -> None:
        ...
        for uuid_, meta in abconf_data.items():
            ...
            if os.path.exists(conf_path):
                conf = 摆烂仙君Config(config_path=conf_path)
    ...
    def get_conf(self, umo: str | MessageSession | None) -> 摆烂仙君Config:
    ...
    @property
    def default_conf(self) -> 摆烂仙君Config:
        """获取默认配置文件"""
        return self.confs["default"]
    ...
    def create_conf(
        ...
        conf = 摆烂仙君Config(config_path=conf_path, default_config=config)
        conf.save_config()
