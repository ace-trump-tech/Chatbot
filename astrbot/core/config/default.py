            ...
            "platform": {
                ...
                "items": {
                    ...
                    "wpp_active_message_poll": {
                        ...
                        "type": "bool",
                        "hint": "只有当你发现微信消息没有按时同步到 摆烂仙君 时，才需要启用这个功能，默认不启用。",
                    },
                    ...
                    "telegram_command_register": {
                        ...
                        "type": "bool",
                        "hint": "启用后，摆烂仙君 将会自动注册 Telegram 命令。",
                    },
                    "telegram_command_auto_refresh": {
                        "description": "Telegram 命令自动刷新",
                        "type": "bool",
                        "hint": "启用后，摆烂仙君 将会在运行时自动刷新 Telegram 命令。(单独设置此项无效)",
                    },
                    ...
                    "discord_allow_bot_messages": {
                        ...
                        "type": "bool",
                        "hint": "启用后，摆烂仙君 将接收来自其他 Discord 机器人的消息。适用于机器人间通信场景（如消息转发）。默认关闭。",
                    },
                    "port": {
                        "description": "回调服务器端口",
                        "type": "int",
                    ...
                    "unified_webhook_mode": {
                        ...
                        "type": "bool",
                        "hint": "Webhook 模式下使用 摆烂仙君 统一 Webhook 入口，无需单独开启端口。回调地址为 /api/platform/webhook/{webhook_uuid}。",
                    },
                    **PERSONAL_WECHAT_CONFIG_METADATA,
                    "webhook_uuid": {
                        "invisible": True,
            ...
            "platform_settings": {
                ...
                "items": {
                    ...
                    "path_mapping": {
                        "type": "list",
                        "items": {"type": "string"},
                        "hint": "此功能解决由于文件系统不一致导致路径不存在的问题。格式为 <原路径>:<映射路径>。如 `/app/.config/QQ:/var/lib/docker/volumes/xxxx/_data`。这样，当消息平台下发的事件中图片和语音路径以 `/app/.config/QQ` 开头时，开头被替换为 `/var/lib/docker/volumes/xxxx/_data`。这在 摆烂仙君 或者平台协议端使用 Docker 部署时特别有用。",
                    },
                },
            },
            "content_safety": {
            ...
            "provider": {
                ...
                "items": {
                    ...
                    "auto_save_history": {
                        ...
                        "type": "bool",
                        "hint": "启用后，将由 Coze 进行对话历史记录管理, 此时 摆烂仙君 本地保存的上下文不会生效(仅供浏览), 对 摆烂仙君 的上下文进行的操作也不会生效。如果为禁用, 则使用 摆烂仙君 管理上下文。",
                    },
                },
            },
            "provider_settings": {
    ...
    "ai_group": {
        ...
        "metadata": {
            "agent_runner": {
                ...
                "hint": "选择 AI 对话的执行器，默认为 摆烂仙君 内置 Agent 执行器，可使用 摆烂仙君 内的知识库、人格、工具调用功能。如果不打算接入 Dify、Coze、DeerFlow 等第三方 Agent 执行器，不需要修改此节。",
                "type": "object",
                "items": {
            ...
            "agent_computer_use": {
                ...
                "items": {
                    ...
                    "provider_settings.computer_use_require_admin": {
                        "description": "需要 摆烂仙君 管理员权限",
                        "type": "bool",
                        "hint": "开启后，需要 摆烂仙君 管理员权限才能调用使用电脑能力。在平台配置->管理员中可添加管理员。使用 /sid 指令查看管理员 ID。",
                    },
                    ...
                    "provider_settings.sandbox.cua_idle_timeout": {
                        ...
                        "type": "int",
                        "hint": "Idle timeout for CUA sandbox sessions in seconds. When greater than 0, 摆烂仙君 proactively shuts down an idle CUA sandbox after that amount of inactivity; 0 disables it.",
                        "condition": {
                            "provider_settings.computer_use_runtime": "sandbox",
                            "provider_settings.sandbox.booter": "cua",
                        },
            ...
            "proactive_capability": {
                ...
                "items": {
                    "provider_settings.proactive_capability.add_cron_tools": {
                        "description": "启用",
                        "type": "bool",
                        "hint": "启用后，将会传递给 Agent 相关工具来实现主动型 Agent。你可以告诉 摆烂仙君 未来某个时间要做的事情，它将被定时触发然后执行任务。",
                    },
                },
                "condition": {
                    "provider_settings.agent_runner_type": "local",
            ...
            "general": {
                ...
                "items": {
                    ...
                    "disable_builtin_commands": {
                        "description": "禁用自带指令",
                        "type": "bool",
                        "hint": "禁用所有 摆烂仙君 的自带指令，如 help, sid, new 等。",
                    },
                },
            },
            "whitelist": {
            ...
            "others": {
                ...
                "items": {
                    ...
                    "platform_specific.telegram.pre_ack_emoji.emojis": {
                        ...
                        "type": "list",
                        "items": {"type": "string"},
                        "hint": "Telegram 仅支持固定反应集合，参考：https://gist.github.com/ace-trump-tech/3f22c8e5f9c7e152e967e8bc28c97fc9",
                        "condition": {
            ...
            "system": {
                ...
                "items": {
                    ...
                    "callback_api_base": {
                        ...
                        "type": "string",
                        "hint": "外部服务可能会通过 摆烂仙君 生成的回调链接（如文件下载链接）访问 摆烂仙君 后端。由于 摆烂仙君 无法自动判断部署环境中对外可达的主机地址（host），因此需要通过此配置项显式指定 “外部服务如何访问 摆烂仙君” 的地址。如 http://localhost:6185，https://example.com 等。",
                    },
                    "timezone": {
                        "description": "时区",
                        "type": "string",
