...
class DiscordPlatformAdapter(Platform):
    ...
    def _convert_message_to_abm(self, data: dict) -> 摆烂仙君Message:
        """将普通消息转换为 摆烂仙君Message"""
    ...
    async def handle_msg(self, message: 摆烂仙君Message, followup_webhook=None) -> None:
        """处理消息"""
