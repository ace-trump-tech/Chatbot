...
class MisskeyPlatformAdapter(Platform):
    ...
    async def convert_message(self, raw_data: dict[str, Any]) -> 摆烂仙君Message:
        """将 Misskey 贴文数据转换为 摆烂仙君Message 对象"""
    ...
    async def convert_chat_message(self, raw_data: dict[str, Any]) -> 摆烂仙君Message:
        """将 Misskey 聊天消息数据转换为 摆烂仙君Message 对象"""
    ...
    async def convert_room_message(self, raw_data: dict[str, Any]) -> 摆烂仙君Message:
        """将 Misskey 群聊消息数据转换为 摆烂仙君Message 对象"""
        sender_info = extract_sender_info(raw_data, is_chat=True)
