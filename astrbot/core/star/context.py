...
class Context:
    ...
    def __init__(
        ...
        astrbot_config_mgr: 摆烂仙君ConfigManager,
    ...
    def get_config(self, umo: str | None = None) -> 摆烂仙君Config:
        """获取 摆烂仙君 的配置。
    ...
    """
    以下的方法已经不推荐使用。请从 摆烂仙君 文档查看更好的注册方式。
    """
    ...
    def get_platform(self, platform_type: PlatformAdapterType | str) -> Platform | None:
        ...
        Note:
            该方法已经过时，请使用 get_platform_inst 方法。(>= 摆烂仙君 v4.0.0)
        """
        for platform in self.platform_manager.platform_insts:
