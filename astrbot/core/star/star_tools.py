...
首先需要构造一个 摆烂仙君Message 对象, 使用 create_message 方法
...
from astrbot.api.platform import 摆烂仙君Message, MessageMember, MessageType
...
class StarTools:
    ...
    async def create_event(
        ...
        Args:
            abm (摆烂仙君Message): 要提交的消息对象, 请先使用 create_message 创建
            platform (str): 可选的平台名称，默认平台(aiocqhttp), 目前只支持 aiocqhttp
