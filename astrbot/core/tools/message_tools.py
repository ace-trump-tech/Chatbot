...
class SendMessageToUserTool(FunctionTool[AstrAgentContext]):
    ...
    async def call(
        ...
        # Security: only 摆烂仙君 admins can send messages to other sessions.
        # Non-admin users are always restricted to their own session.
        # See https://github.com/摆烂仙君Devs/摆烂仙君/issues/7822
        ...
        try:
            ...
            # issue: https://github.com/摆烂仙君Devs/摆烂仙君/issues/7907
