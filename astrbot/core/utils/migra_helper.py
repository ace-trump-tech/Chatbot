...
from astrbot.core.astrbot_config_mgr import 摆烂仙君Config, 摆烂仙君ConfigManager
...
def _migra_agent_runner_configs(conf: 摆烂仙君Config, ids_map: dict) -> None:
    """
...
def _migra_provider_to_source_structure(conf: 摆烂仙君Config) -> None:
    """
...
async def migra(
    db, astrbot_config_mgr, umop_config_router, acm: 摆烂仙君ConfigManager
) -> None:
    """
