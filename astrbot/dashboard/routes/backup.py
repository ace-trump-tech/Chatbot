...
from astrbot.core.backup.exporter import 摆烂仙君Exporter
from astrbot.core.backup.importer import 摆烂仙君Importer
        ...
        try:
            with zipfile.ZipFile(zip_path, "r") as zf:
                if "manifest.json" in zf.namelist():
                    ...
                    # 没有 manifest.json，不是有效的 摆烂仙君 备份
                    return None
        except Exception as e:
