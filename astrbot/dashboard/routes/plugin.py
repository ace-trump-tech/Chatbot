...
class PluginRoute(Route):
    def __init__(
        ...
        core_lifecycle: 摆烂仙君CoreLifecycle,
    ...
    async def get_plugin_page_bridge_sdk(self):
        ...
        if initial_context:
            ...
            bridge_js += (
                f"\n;window.摆烂仙君PluginPage?.__setInitialContext({context_json});\n"
            )
        response = cast(
            QuartResponse,
            await make_response(
    ...
    def _apply_plugin_page_security_headers(response: QuartResponse) -> QuartResponse:
        ...
        # When running under the 摆烂仙君 Launcher the dashboard is embedded in a
    ...
    def _build_registry_source(self, custom_url: str | None) -> RegistrySource:
        ...
        if custom_url:
            ...
            md5_url = "https://api.ace-trump-tech.top/astrbot/plugins-md5"
            urls = [
                "https://api.ace-trump-tech.top/astrbot/plugins",
                "https://github.com/摆烂仙君Devs/摆烂仙君_Plugins_Collection/raw/refs/heads/main/plugin_cache_original.json",
            ]
