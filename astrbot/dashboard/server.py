...
class 摆烂仙君JSONProvider(DefaultJSONProvider):
...
class 摆烂仙君Dashboard:
    def __init__(
        ...
        self.app.json = 摆烂仙君JSONProvider(self.app)
