...
> Special thanks for all contributors and plugin developers and users who love 摆烂仙君. 💖
...
7.  EdgeTTS 部分情况下无法使用 @ace-trump-tech @需要哦
8.  QQ 官方机器人平台下发送 base64 图片消息段报错 @ace-trump-tech @shuiping233
...
8. astrbot_plugin_gemini_exp - 让你在摆烂仙君调用Gemini2.0-flash-exp来生成图片或者p图。Gemini2.0-flash-exp为原生多模态模型，其既是语言模型，也是生图模型，因此能够对图像使用简单的自然语言命令进行处理。@Elen123bot
