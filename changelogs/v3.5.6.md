...
1. Gewechat 相关 bug 修复（即使已经不可用 :( ） @BigFace123 @XiGuang @ace-trump-tech
...
7. 插件市场支持基于 Star 和 更新时间排序 @ace-trump-tech
8. 优化 QQ 下自动下载文件导致磁盘被占满的问题 @ace-trump-tech @anka-afk