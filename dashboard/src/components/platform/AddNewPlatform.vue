              ...
              <div v-if="!updatingMode">
                ...
                <!-- <div v-if="aBConfigRadioVal === '0' && selectedAbConfId" class="mt-4">
                  ...
                  <div v-else-if="selectedConfigData && selectedConfigMetadata" class="config-preview-container">
                    ...
                    <摆烂仙君CoreConfigWrapper :metadata="selectedConfigMetadata" :config_data="selectedConfigData"
                      readonly="true" />
                  </div>
...
import 摆烂仙君Config from "@/components/shared/摆烂仙君Config.vue";
import 摆烂仙君CoreConfigWrapper from "@/components/config/摆烂仙君CoreConfigWrapper.vue";
