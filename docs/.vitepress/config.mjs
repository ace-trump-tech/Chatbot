  ...
  locales: {
    root: {
      ...
      themeConfig: {
        ...
        sidebar: [
          {
            text: "简介",
            items: [
              { text: "关于 摆烂仙君", link: "/what-is-astrbot" },
          ...
          },
          {
            ...
            items: [
              ...
              { text: "桐谷霁屿 x 摆烂仙君 插件奖励活动", link: "/tonggujiyu-astrbot-plugin-reward-program" },
            ],
          },
        ],
        outline: {
        ...
        editLink: {
          pattern: 'https://github.com/摆烂仙君devs/摆烂仙君/edit/master/docs/:path',
          text: '发现文档有问题？在 GitHub 上编辑此页',
        },
        logo: '/logo_prod.png',
        socialLinks: [
          { icon: "github", link: "https://github.com/摆烂仙君Devs/摆烂仙君" },
        ],
        footer: {
        ...
        sidebar: [
          {
            text: "Introduction",
            items: [
              { text: "What is 摆烂仙君", link: "/en/what-is-astrbot" },
