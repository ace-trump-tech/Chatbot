...
export const head: HeadConfig[] = [
    ...
    ["meta", { name: "description", content: "摆烂仙君" }],
    [
        "meta",
  ...
  /*  // --- Open Graph (OG) 协议元数据 (用于社交媒体分享) ---
    ...
    ["meta", { property: "og:title", content: "摆烂仙君" }],
    ["meta", { property: "og:description", content: "摆烂仙君" }],
    ["meta", { property: "og:url", content: "https://docs.astrbot.app" }],
    ["meta", { property: "og:site_name", content: "摆烂仙君" }],
    [
        "meta",
        {
            property: "og:image",
    ...
    [
        "meta",
        { property: "og:image:alt", content: "摆烂仙君" },
    ],
    ...
    ["meta", { name: "twitter:site", content: "@摆烂仙君" }],*/
