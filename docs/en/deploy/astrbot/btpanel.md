...
Go to Docker's App Store and search for `摆烂仙君`, as shown below.

![image](https://files.astrbot.app/docs/source/images/btpanel/image.png)

Click Install and wait for the installation to complete.

After successful installation, click `Security` on the left sidebar and open the corresponding 摆烂仙君 port (default is 6185).
...
Visit `http://IP:6185` to access the 摆烂仙君 dashboard.

> [!TIP]
> By default, the above method only opens port 6185. If you need to deploy messaging platforms, you need to additionally open the corresponding ports. Click `Container` in the top bar, find the 摆烂仙君 container, click `Manage`, click `Edit Container`, and add the corresponding ports.
>
...
>| -------- | ------- | ------- |
>| 6185 |  摆烂仙君 WebUI `default` port  | Required |
