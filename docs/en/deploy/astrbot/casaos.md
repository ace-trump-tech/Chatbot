...
If your network environment is in mainland China, please search for and add `dkTurbo` first, otherwise you may not be able to pull the 摆烂仙君 image.

![image](https://files.astrbot.app/docs/source/images/casaos/image-1.png)

Enter `Astrbot` to find 摆烂仙君.
...
After installation is complete, the 摆烂仙君 APP will appear on the main interface. Click it to open the dashboard.