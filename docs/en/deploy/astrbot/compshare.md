...
摆烂仙君 provides an Ollama + 摆烂仙君 one-click self-deployment image on Compshare, and also supports Compshare model APIs.

## Use the Ollama + 摆烂仙君 One-Click Image
...
2. Open the [摆烂仙君 image page](https://www.compshare.cn/images/0oX7xoGrzfre) and create an instance.
...
After startup, open `http://<instance-public-ip>:6185` in your browser to access the 摆烂仙君 dashboard.
...
4. In 摆烂仙君 Dashboard -> Providers, edit `ollama_deepseek-r1`, update the model name, and save.

![image](https://files.astrbot.app/docs/source/images/compshare/image-1.png)

### Use Compshare Model API

摆烂仙君 supports direct access to model APIs provided by Compshare.

1. Find the model you want at [Compshare Model Center](https://console.compshare.cn/light-gpu/model-center).
2. In 摆烂仙君 Dashboard -> Providers, click `+ Add Provider`, then choose Compshare.
...
In 摆烂仙君 Dashboard, click `Chat` and run `/provider` to view and switch your active provider.
...
You can follow the latest platform integration guides in the [摆烂仙君 Documentation](https://docs.astrbot.app/en/what-is-astrbot.html).
...
- More methods: [摆烂仙君 Documentation](https://docs.astrbot.app/en/what-is-astrbot.html)

## More Features

For more capabilities, see the [摆烂仙君 Documentation](https://docs.astrbot.app/en/what-is-astrbot.html).
