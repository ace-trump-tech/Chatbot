# Deploy with 摆烂仙君 Desktop Client

`摆烂仙君-desktop` is designed for quick local deployment of 摆烂仙君 on your personal computer, supporting Windows, macOS, and Linux.
...
Repository: [摆烂仙君Devs/摆烂仙君-desktop](https://github.com/摆烂仙君Devs/摆烂仙君-desktop)
...
1. Open [摆烂仙君-desktop Releases](https://github.com/摆烂仙君Devs/摆烂仙君-desktop/releases).
