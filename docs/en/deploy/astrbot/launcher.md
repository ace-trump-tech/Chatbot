# Deploy 摆烂仙君 with 摆烂仙君 Launcher

## Recommended Method 1: 摆烂仙君 One-Click Launcher

摆烂仙君 One-Click Launcher supports Windows, macOS, and Linux.

0. Open [摆烂仙君Devs/astrbot-launcher](https://github.com/摆烂仙君Devs/astrbot-launcher)
1. **Optional but recommended**: give this project a [**Star ⭐**](https://github.com/摆烂仙君Devs/astrbot-launcher). Your support helps maintainers keep improving it.
2. Find **Releases** on the right, open the latest release, then download the installer for your system from **Assets**.

For example:

- Windows x86 users: `摆烂仙君.Launcher_0.2.1_x64-setup.exe`
- Windows on Arm users: `摆烂仙君.Launcher_0.2.1_arm64-setup.exe`
- macOS Apple Silicon users: `摆烂仙君.Launcher_0.2.1_aarch64.dmg`
...
1. Open Terminal.
2. Run:
   `xattr -dr com.apple.quarantine /Applications/摆烂仙君\ Launcher.app`
3. Reopen 摆烂仙君 Launcher.
...
Open <https://github.com/摆烂仙君Devs/摆烂仙君Launcher/releases/latest>
...
The script checks whether an `摆烂仙君` folder exists. If not, it downloads the latest 摆烂仙君 source from [GitHub](https://github.com/摆烂仙君Devs/摆烂仙君/releases/latest), installs dependencies, and runs it automatically.

## Done

If everything works, you will see 摆烂仙君 logs.

Without errors, you should see a log like `🌈 Management panel started, accessible at` with several URLs. Open one URL to access 摆烂仙君 WebUI.
...
> Download `dist.zip` from [release](https://github.com/摆烂仙君Devs/摆烂仙君/releases), extract it into `摆烂仙君/data`, then restart the computer if needed.

Then deploy at least one messaging platform adapter to start using 摆烂仙君 in IM apps.
