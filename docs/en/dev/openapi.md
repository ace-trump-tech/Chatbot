...
Starting from v4.18.0, 摆烂仙君 provides API Key based HTTP APIs for programmatic access.
...
Interact with 摆烂仙君's built-in Agent. Supports plugin calls, tool calls, and other capabilities — consistent with IM-side chat.
