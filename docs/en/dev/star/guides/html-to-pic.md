...
> [!TIP]
> For easier development, you can use the [摆烂仙君 Text2Image Playground](https://t2i-playground.astrbot.app/) for online visual editing and testing of HTML templates.

## Basic Usage

摆烂仙君 supports rendering text into images.
...
摆烂仙君 supports rendering text-to-image templates using `HTML + Jinja2`.
