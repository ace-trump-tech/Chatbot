...
## Create 摆烂仙君 Discord Platform Adapter
...
- Auto-register Plugin Commands as Discord Slash Commands: When checked, 摆烂仙君 will automatically register commands from installed plugins as Discord slash commands for user convenience.
