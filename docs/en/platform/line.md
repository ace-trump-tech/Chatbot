...
- `LINE Bot User ID`: optional; if empty, 摆烂仙君 uses webhook `destination`
...
> [!TIP]
> If 摆烂仙君 is not publicly reachable, set up a public domain and reverse proxy first so LINE can access your webhook URL.
