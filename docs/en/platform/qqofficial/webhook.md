...
Your domain should reverse-proxy traffic to 摆烂仙君 port `6196` using `Caddy`, `Nginx`, or `Apache`.
...
摆烂仙君 should now be connected. If messages do not respond immediately, wait 1-2 minutes, restart 摆烂仙君, and test again.
