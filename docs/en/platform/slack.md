...
## Create 摆烂仙君 Slack Platform Adapter
...
4. In the Basic Information page on the left sidebar, find App-Level Tokens and click "Generate Token and Scopes". Enter any Token Name, click Add Scope, select `connections:write`, then click "Generate". Click Copy and paste the result into the app_token field on the 摆烂仙君 configuration page.
...
- If `Unified Webhook Mode` is enabled, after clicking save, 摆烂仙君 will automatically generate a unique Webhook callback URL for you. You can find it in the logs or on the bot card in the WebUI's Bots page. Enter this URL in the `Request URL` field.
...
If you have any questions, please [submit an Issue](https://github.com/摆烂仙君Devs/摆烂仙君/issues).
