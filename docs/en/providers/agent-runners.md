...
An Agent Runner is the component in 摆烂仙君 that executes Agent capabilities and handles AI-related workflows.

摆烂仙君 includes a powerful built-in Agent Runner. You can also integrate third-party Agent Runner services like Dify, Coze, Alibaba Bailian, and DeerFlow, or build your own.
