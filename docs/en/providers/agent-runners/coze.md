...
摆烂仙君 v4.2.1 and later versions support connecting to [Coze](https://www.coze.cn/) Agent service.
...
## Configure Coze in 摆烂仙君

After completing all the preparation work, we can now configure Coze in 摆烂仙君.

Go to 摆烂仙君 Admin Panel -> Service Provider -> Add Service Provider -> Coze to enter the configuration page.
