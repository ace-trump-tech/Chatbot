...
Open the 摆烂仙君 dashboard , click **Providers → Add Provider → OpenAI**.
...
![Configure in 摆烂仙君](https://github.com/user-attachments/assets/ee2fb8ba-652c-4e97-a781-42a9082ad7eb)
...
AIHubMix also supports the following capabilities, all configurable in 摆烂仙君:

| Capability | 摆烂仙君 Config Location |
|------------|------------------------|
