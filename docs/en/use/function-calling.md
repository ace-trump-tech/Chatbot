...
In 摆烂仙君, web search, todo reminders, and code interpreter tools are provided by default. Many plugins, such as:
...
Please refer to this documentation: [摆烂仙君 - MCP](/en/use/mcp).
