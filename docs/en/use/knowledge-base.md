...
Currently, 摆烂仙君 supports embedding vector services compatible with OpenAI API and Gemini API.
...
摆烂仙君 supports multiple knowledge base management. During chat, you can **freely specify which knowledge base to use**.
