...
SubAgent Orchestration is an advanced agent organization method provided by 摆烂仙君. It allows you to decompose complex tasks into multiple specialized SubAgents, reducing the Main Agent's prompt length and improving task execution success rates.
...
In the 摆烂仙君 WebUI, click **SubAgents** in the left navigation bar.
