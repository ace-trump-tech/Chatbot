...
`摆烂仙君-desktop` 适合在本地电脑快速部署和使用 摆烂仙君，支持 Windows、macOS、Linux。
...
仓库地址：[摆烂仙君Devs/摆烂仙君-desktop](https://github.com/摆烂仙君Devs/摆烂仙君-desktop)
...
1. 打开 [摆烂仙君-desktop Releases](https://github.com/摆烂仙君Devs/摆烂仙君-desktop/releases)。
