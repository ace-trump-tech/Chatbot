...
class Test摆烂仙君Exporter:
    ...
    def test_model_to_dict_with_model_dump(self):
        ...
        exporter = 摆烂仙君Exporter(main_db=MagicMock())
...
class Test摆烂仙君Importer:
    ...
    def test_validate_version_match(self):
        """测试版本匹配验证"""
        importer = 摆烂仙君Importer(main_db=MagicMock())
    ...
    async def test_import_file_not_exists(self, mock_main_db, tmp_path):
        """测试导入不存在的文件"""
        importer = 摆烂仙君Importer(main_db=mock_main_db)
