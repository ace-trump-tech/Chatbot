"""Tests for 摆烂仙君Message and MessageMember classes."""

import time
from unittest.mock import patch

from astrbot.core.message.components import Image, Plain
from astrbot.core.platform.astrbot_message import 摆烂仙君Message, Group, MessageMember
...
class Test摆烂仙君Message:
    """Tests for 摆烂仙君Message class."""

    def test_astrbot_message_creation(self):
        """Test creating an 摆烂仙君Message."""
        message = 摆烂仙君Message()
    ...
    def test_astrbot_message_all_attributes(self):
        """Test setting all attributes on 摆烂仙君Message."""
        message = 摆烂仙君Message()
...
class Test摆烂仙君MessageGroupId:
    """Tests for 摆烂仙君Message group_id property."""
...
class Test摆烂仙君MessageTypes:
    """Tests for 摆烂仙君Message with different message types."""

    def test_friend_message_type(self):
        """Test 摆烂仙君Message with FRIEND_MESSAGE type."""
        message = 摆烂仙君Message()
        message.type = MessageType.FRIEND_MESSAGE
    ...
    def test_group_message_type(self):
        """Test 摆烂仙君Message with GROUP_MESSAGE type."""
        message = 摆烂仙君Message()
    ...
    def test_other_message_type(self):
        """Test 摆烂仙君Message with OTHER_MESSAGE type."""
        message = 摆烂仙君Message()
...
class Test摆烂仙君MessageChain:
    """Tests for 摆烂仙君Message message chain."""
